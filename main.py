...
if __name__ == '__main__':
    ...
    model_paths = [join(args.model_location, f) for f in listdir(args.model_location) if isfile(join(args.model_location, f)) and 'uniform' not in f and 'greedy' not in f]
    ...
    if args.uniform_soup:
        ...
        torch.save(save_dict, f'{args.model_location}/uniform_soup_test.pth.tar')
